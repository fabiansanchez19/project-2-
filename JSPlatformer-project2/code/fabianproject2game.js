...
function ring2(pos) {
	...
	this.size = new Vector(2.5, 0.5);
	this.wobble = Math.random() * Math.PI * 3;
}

ring2.prototype.type = "ring2";

function ring3(pos) {
	this.basePos = this.pos = pos.plus(new Vector(0.0,0.5));
	this.size = new Vector(1.0, 0.5);
	this.wobble = Math.random() * Math.PI * 3;
}

ring3.prototype.type = "ring3";
...
var wobbleSpeed = 18, wobbleDist = 0.6;
...
var wobbleSpeed = 10, wobbleDist = 0.05;

var wobbleSpeed2 = 10;
var wobbleDist2 = 0.07;
ring2.prototype.act = function(step) {
...
var wobbleSpeed3 = 0;
var wobbleDist3 = 0.0;
ring3.prototype.act = function(step) {
